...
class TestSecuencia(TestCase):
    ...
    def test_Iteracion3conDosNumeros(self):
        self.assertEqual(Secuencia().verificarSecuencia("1,4")[0], 2, "Con dos numeros")
        self.assertEqual(Secuencia().verificarSecuencia("1,4")[1], 1, "Con dos numeros")
        self.assertEqual(Secuencia().verificarSecuencia("1,4")[2], 4, "Con dos numeros")

    def test_Iteracion3conNNumeros(self):
        self.assertEqual(Secuencia().verificarSecuencia("8,4,4,3,5,6")[0], 6, "Con N numeros")
        self.assertEqual(Secuencia().verificarSecuencia("8,4,4,3,5,6")[1], 3, "Con N numeros")
        self.assertEqual(Secuencia().verificarSecuencia("8,4,4,3,5,6")[2], 8, "Con N numeros")

    def test_Iteracion4cadenaVacia(self):
        self.assertEqual(Secuencia().verificarSecuencia("")[0], 0, "Cadena vacia")
        self.assertEqual(Secuencia().verificarSecuencia("")[1], 0, "Cadena vacia")
        self.assertEqual(Secuencia().verificarSecuencia("")[2], 0, "Cadena vacia")
        self.assertEqual(Secuencia().verificarSecuencia("")[3], 0, "Cadena vacia")

    def test_Iteracion4conUnNumero(self):
        self.assertEqual(Secuencia().verificarSecuencia("2")[0], 1, "Con un numero")
        self.assertEqual(Secuencia().verificarSecuencia("2")[1], 2, "Con un numero")
        self.assertEqual(Secuencia().verificarSecuencia("2")[2], 2, "Con un numero")
        self.assertEqual(Secuencia().verificarSecuencia("2")[3], 2, "Con un numero")

    def test_Iteracion4conDosNumeros(self):
        self.assertEqual(Secuencia().verificarSecuencia("1,4")[0], 2, "Con dos numeros")
        self.assertEqual(Secuencia().verificarSecuencia("1,4")[1], 1, "Con dos numeros")
        self.assertEqual(Secuencia().verificarSecuencia("1,4")[2], 4, "Con dos numeros")
        self.assertEqual(Secuencia().verificarSecuencia("1,4")[3], 2.5, "Con dos numeros")

    def test_Iteracion4conNNumeros(self):
        self.assertEqual(Secuencia().verificarSecuencia("8,4,4,3,5,6")[0], 6, "Con N numeros")
        self.assertEqual(Secuencia().verificarSecuencia("8,4,4,3,5,6")[1], 3, "Con N numeros")
        self.assertEqual(Secuencia().verificarSecuencia("8,4,4,3,5,6")[2], 8, "Con N numeros")
        self.assertEqual(Secuencia().verificarSecuencia("8,4,4,3,5,6")[3], 5, "Con N numeros")
